...
namespace Comercio.Models
{
    public class ErrorViewModel
    {
        ...
        public ErrorViewModel ProdutoErroAoCarregarFornecedores()
        {
            this.Mensagem = "Não foi possível carregar os fornecedores.";
            return this;
        }
        ...
        public ErrorViewModel FornecedorErroAoTentarEditarEndereco()
        {
        ...
        public ErrorViewModel FornecedorErroAoTentarExcluirVendedor()
        {
            this.Mensagem = "Erro ao tentar excluir o vendedor do fornecedor.";
            return this;
        }

        public ErrorViewModel FornecedorErroAoTentarEditarVendedor()
        {
            this.Mensagem = "Erro ao tentar editar o vendedor do fornecedor.";
            return this;
        }

        public ErrorViewModel FornecedorErroAoBuscarFornecedor()
        {
