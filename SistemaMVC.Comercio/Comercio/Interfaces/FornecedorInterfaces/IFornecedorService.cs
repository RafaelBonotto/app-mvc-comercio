...
namespace Comercio.Interfaces.FornecedorInterfaces
{
    public interface IFornecedorService
    {
        ...
        Task<bool> InserirVendedor(int fornecedor_id, string ddd, string numero, string tipoTelefone, string dddAdicional, string numeroAdicional, string tipoTelefoneAdicional);
